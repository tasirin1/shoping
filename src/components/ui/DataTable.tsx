        ...
        {onSearchChange && (
          <div className="relative w-full sm:w-72 lg:w-80">
            ...
            <input
              ...
              className="w-full min-w-0 pl-9 pr-9 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/15 transition-all"
            />
            {search && (
